...
@Index("idx_litebans_warnings_uuid", ["uuid"], {})
@Index("idx_litebans_warnings_ip", ["ip"], {})
@Index("idx_litebans_warnings_banned_by_uuid", ["bannedByUuid"], {})
@Index("idx_litebans_warnings_time", ["time"], {})
@Index("idx_litebans_warnings_until", ["until"], {})
@Index("idx_litebans_warnings_ipban", ["ipban"], {})
@Index("idx_litebans_warnings_ipban_wildcard", ["ipbanWildcard"], {})
@Index("idx_litebans_warnings_active", ["active"], {})
@Entity("litebans_warnings", { schema: "litebans" })
export class LitebansWarnings {
